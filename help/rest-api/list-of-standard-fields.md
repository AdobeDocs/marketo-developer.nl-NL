...
| anoniemIP | AnonymousIP | Anonieme IP | IP adres van het eerste geregistreerde Webbezoek van de lood |
| billingCity | BillingCity | Factureringsplaats | Plaats van het factuuradres van de lead |
| factureringsland | Factureringsland | Factureringsland | Land van het factuuradres van de lead |
| billingPostalCode | BillingPostalCode | Postcode facturering | Postcode van het factuuradres van de lead |
| factureringsstatus | BillingState | Factureringsstatus | Staat of provincie van het factuuradres van de lead |
...
| doNotCallReason | DoNotCallReason | Reden niet aanroepen | Uitleg voor do-not-call voorkeur van lood |
...
| inferredCompany | InferredCompany | Overgenomen onderneming | De naam van het bedrijf die door omgekeerde IP raadpleging van het eerste geregistreerde Webbezoek van de lood wordt afgeleid |
| inferredCountry | InferredCountry | Overgenomen land | Land dat wordt afgeleid door omgekeerde IP-zoekopdracht van het eerste opgenomen webbezoek van de lead |
| lastName | LastName | Achternaam | Achternaam van lead |
| leadRole | LeadRole | Functie | Rol van de leider in hun bedrijf |
| leadScore | LeadScore | Loodscore | Gehele score toegekend aan de leider door scènes en programma&#39;s |
| leadSource | LeadSource | Lead Source | Veld waarin wordt vastgelegd van welke bron de lead afkomstig is |
| leadStatus | LeadStatus | Leadstatus | Veld waarin de huidige marketing-/verkoopstatus van de lead wordt geregistreerd |
| mainPhone | MainPhone | Hoofdtelefoon | Primair telefoonnummer van het bedrijf van de lead |
...
| telefoon | Telefoon | Telefoonnummer | Telefoonnummer van lead |
| postcode | Postcode | Postcode | Postcode van lead |
| beoordeling | Classificatie | Waardering lood | Marketing-/verkoopclassificatie van de lead |
| aanhef | Aanhef | Aanhef | De voorkeursalutatie van lood, dat is Mister, Misses, enzovoort. |
