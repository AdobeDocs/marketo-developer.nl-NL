...
Deze functie retourneert de namen van Marketo-objecten die kunnen worden gebruikt als invoer in de [describeMObjects](./describemobject.md) functie voor schema-detectiebewerkingen.

## Verzoek

_Er zijn geen invoer voor deze API_
