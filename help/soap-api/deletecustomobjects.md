...
description: Leer hoe u deleteCustomObjects in de Marketo SOAP API kunt gebruiken om aangepaste objecten te verwijderen met behulp van sleutelkenmerken zoals VERWIJDERD, ONGEWIJZIGD, NIET-GEWIJZIGDE status plus XML, PHP, Java.
...
Verwijdert een of meer aangepaste objecten en retourneert het resultaat van de bewerking (VERWIJDERD, ONGEWIJZIGD, MISLUKT).

## Verzoek

| Veldnaam | Vereist/optioneel | Beschrijving |
| --- | --- | --- |
| objTypeName | Vereist | Naam van het aangepaste object |
| customObjKeyLists->keyList->attribute | Vereist | Het kenmerk is een sleutel-/waardepaar dat wordt gebruikt om de aangepaste objecten te identificeren die u wilt verwijderen. U kunt meerdere kenmerken opgeven in de customObjKeyLists |
