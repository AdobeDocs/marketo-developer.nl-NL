...
Goedkeuren en we zijn bereid onze campagne te voeren:
...
Voordat u de activering uitvoert, moet u een aantal instellingen opgeven op het tabblad Planning. Als deze specifieke e-mail maar één keer naar een bepaalde record moet worden verzonden, laat u de kwalificatie-instellingen ongewijzigd. Als de e-mail echter meerdere keren moet worden ontvangen, wilt u deze instelling elke keer aanpassen of op een van de beschikbare paden:
...
Tokens kunnen niet worden opgeslagen als ze leeg zijn, dus voeg hier wat plaatsaanduidingstekst in. Nu moeten we ons token invoegen in de e-mail:
