...
Gebruik het [ Concept van het Type van Objecten van de Douane van de Weigering ](https://developer.adobe.com/marketo-apis/api/mapi#tag/Custom-Objects/operation/discardCustomObjectTypeUsingPOST) eindpunt om een ontwerp versie te schrappen. `apiName` is de enige vereiste parameter als padparameter. Een type moet in ontwerpstaat zijn om te worden verworpen, dat een goedgekeurd type niet kan worden verworpen.
