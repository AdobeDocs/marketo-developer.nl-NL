...
title: "getTags"
feature: SOAP, Tags
description: "getTags SOAP-aanroepen"
...
| --- | --- | --- |
| tagList->tag | Optioneel | Lijst met tags waarop u een query wilt uitvoeren. Elke tag kan een type en een array van waarden als tekenreeksen hebben. Indien `<tagList>` wordt weggelaten, ontvangt u informatie over alle kanalen |
