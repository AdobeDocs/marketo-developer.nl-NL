...
title: mergeLeads
feature: SOAP
description: Gebruik mergeLeads met Marketo SOAP om winnende en verliesnovergangen samen te voegen. Bevat aanvraagvelden, XML-aanvraag en -antwoord, en PHP- en Java-voorbeelden.
...
Accepteert de sleutel van een winnende lood en de veelvoudige verliezers sleutels om een fusieverrichting uit te voeren. Retourneert de id van de leads en status.

## Verzoek

| Veldnaam | Vereist/optioneel | Beschrijving |
| --- | --- | --- |
| winningLeadKeyList | Vereist | De sleutel die wordt gebruikt om de winnende lood te identificeren. Mogelijke waarden zijn: `IDNUM` , `EMAIL` , `SFDCLEADID` , `LEADOWNEREMAIL` , `SFDCACCOUNTID` , `SFDCCONTACTID` , `SFDCLEADID` , `SFDCLEADOWNERID` , `SFDCOPPTYID` |
| losingLeadKeyLists | Vereist | Een lijst met sleutels die worden gebruikt om de verliezende leads te identificeren. |
| mergeInSales | Optioneel | Doorgegeven als een booleaanse waarde, true of False |
