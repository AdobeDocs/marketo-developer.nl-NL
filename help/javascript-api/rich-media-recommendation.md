...
**Naam**: template3 **Beschrijving**: Verticale inhoud met inbegrip van slechts titel en beschrijving. Bij de muisaanwijzer verandert de koptekst van kleur en is deze gekoppeld aan de URL van de inhoud. Beschrijving is ook gekoppeld aan inhoud zonder kleurwijziging. ![Sjabloon voor rijke media &#x200B;](assets/rich-media-template3.png)
