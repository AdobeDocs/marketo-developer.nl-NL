...
feature: REST API
description: "Het gebruiken van veilige authentificatie voor het verzenden van berichten."
...
Het cliëntprogramma berekent de handtekening HMAC-SHA1 gebruikend gedeelde geheim-sleutel en een deel van de inhoud van het verzoekbericht. De cliënt moet een kopbal van de ZEEP, AuthenticationHeaderInfo, omvatten om authentificatieinformatie met het bericht van de ZEEP over te gaan.
...
| `partnerId` | Optioneel | Technologiepartner van LaunchPoint [API-sleutel](../launchpoint-api.pdf). |
