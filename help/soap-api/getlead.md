...
title: "getLead"
feature: SOAP
description: "getLead SOAP-aanroepen"
...
Deze functie haalt één loodrecord op uit Marketo, met alle veldwaarden voor de ingebouwde en aangepaste velden, voor een lead die wordt geïdentificeerd door de opgegeven sleutel (LeadKey). Als de lead bestaat op basis van de invoerparameters, worden de kenmerken van de lead record geretourneerd in het resultaat.

NOTA: De attributen van de lood die van koordgegevenstype zijn en leeg zijn zullen niet als deel van de reactie worden teruggekeerd.
...
| leadKey->keyValue | Vereist | keyValue is de waarde u wenst om lood door te vragen. |
