...
Hieronder vindt u een reeks demonstratieve e-mailscriptvoorbeelden.

## Lijst met gebeurtenissen

In dit voorbeeld wordt een aangepast Event-object gebruikt.
...
## Escape een tekenreeks die HTML onveilig kan zijn
