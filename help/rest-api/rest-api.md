...
>[!IMPORTANT]
>
>Zie dit [&#x200B; post van de Natie &#x200B;](https://nation.marketo.com/t5/product-blogs/rest-api-double-slash-deprecation/ba-p/358616) over de veroudering van de dubbele schuine streep in API gateway URLs.
>
...
Klik op het tabblad **[!UICONTROL Roles]** en vervolgens op Nieuwe rol en wijs ten minste de machtiging Alleen-lezen regel (of Alleen-lezen persoon) toe aan de rol in de API-groep Toegang. Geef deze een beschrijvende naam en selecteer **[!UICONTROL Create]** .

![&#x200B; Nieuwe Rol &#x200B;](assets/new-role.png)

Ga nu terug naar de tab [!UICONTROL Users] en selecteer **[!UICONTROL Invite New User]** . Geef uw gebruiker een beschrijvende naam die aangeeft dat het een API-gebruiker is, en een e-mailadres en selecteer **[!UICONTROL Next]** .

![&#x200B; Nieuwe Informatie van de Gebruiker &#x200B;](assets/new-user-info.png)

Controleer vervolgens de optie [!UICONTROL API Only] en geef de gebruiker de API-rol die u hebt gemaakt en selecteer **[!UICONTROL Next]** .

![&#x200B; Nieuwe Toestemmingen van de Gebruiker &#x200B;](assets/new-user-permissions.png)

Selecteer **[!UICONTROL Send]** als u het maken van de gebruiker wilt voltooien.

![&#x200B; Nieuw Bericht van de Gebruiker &#x200B;](assets/new-user-message.png)

Ga vervolgens naar het menu [!UICONTROL Admin] en selecteer **[!UICONTROL LaunchPoint]** .

![&#x200B; Lanceerpunt &#x200B;](assets/admin-launchpoint.png)

Klik op het menu **[!UICONTROL New]** en selecteer **[!UICONTROL New Service]** . Geef uw service een beschrijvende naam en selecteer **[!UICONTROL Custom]** in het vervolgkeuzemenu [!UICONTROL Service] . Geef deze een beschrijving, selecteer vervolgens de nieuwe gebruiker in het vervolgkeuzemenu [!UICONTROL API Only User] en selecteer **[!UICONTROL Create]** .

![&#x200B; Nieuwe Dienst van het Lanceerpunt &#x200B;](assets/admin-launchpoint-new-service.png)

Selecteer **[!UICONTROL View Details]** voor uw nieuwe service om toegang te krijgen tot de client-id en het clientgeheim. U kunt nu **[!UICONTROL Get Token]** selecteren om een toegangstoken te genereren dat één uur geldig is. Sla het token voorlopig op in een notitie.
...
Als u geen lead record hebt met uw e-mailadres in uw database, vervangt u dit door een adres dat u wel kent. Druk op Enter in de URL-balk en u krijgt een JSON-reactie die hierop lijkt:
...
Voor REST eindpunten die dagelijks en laatste-7 dagen gebruik en foutenstatistieken terugkeren, zie [&#x200B; Gebruik &#x200B;](usage.md).
