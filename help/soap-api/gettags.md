...
title: getTags
feature: SOAP, Tags
description: Marketo SOAP getTags haalt niet-kanaallabeltypen en -waarden op met optionele tagfilters, plus aanvraagvelden en volledige voorbeelden van reacties op XML-verzoeken.
...
Deze functie haalt de volgende informatie op over tags anders dan kanalen die zijn ingesteld in Marketo.

- Type code
- Tagwaarde

U kunt informatie opvragen over alle niet-kanaaltags of een specifieke lijst met tags en/of waarden opgeven.

## Verzoek

| Veldnaam | Vereist/optioneel | Beschrijving |
| --- | --- | --- |
| tagList->tag | Optioneel | Lijst met tags waarop u een query wilt uitvoeren. Elke tag kan een type en een array van waarden als tekenreeksen hebben. Als `<tagList>` wordt weggelaten, ontvangt u informatie over alle kanalen |
