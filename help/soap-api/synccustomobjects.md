...
feature: SOAP
description: "syncCustomObjects SOAP call"
...
Voor aangepaste objecten die zijn ingericht met de nieuwe interface voor aangepaste objecten, worden alleen velden aangegeven als `dedupe` velden in de gebruikersinterface kunnen als kenmerken worden doorgegeven in `CustomObjKeyList`. Velden koppelen die niet `dedupe` velden moeten als kenmerk worden doorgegeven in `customObjAttributeList`.
