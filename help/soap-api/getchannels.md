...
Deze functie haalt de volgende informatie op over een kanaal dat is ingesteld in Marketo:

- Progressiestatus
- Stapnummer van elke progressiestatus
- Of een specifieke progressiestatus als succes is gedefinieerd

U kunt informatie opvragen over alle kanalen of een specifieke lijst met kanalen opgeven

## Verzoek

| Veldnaam | Vereist/optioneel | Beschrijving |
| --- | --- | --- |
| tag->values->stringItem | Optioneel | Lijst met kanalen waarop u een query wilt uitvoeren. Indien `<tag>` wordt weggelaten, ontvangt u informatie over alle kanalen |
